...
void esp_zb_app_signal_handler(esp_zb_app_signal_t *signal_struct)
{
    ...
    case ESP_ZB_NLME_STATUS_INDICATION:
        esp_zb_zdo_signal_nwk_status_indication_params_t *nwk_status_ind = (esp_zb_zdo_signal_nwk_status_indication_params_t *)esp_zb_app_signal_get_params(p_sg_p);
         
        ESP_LOGI(TAG, "NLME status indication: %s", esp_err_to_name(err_status));
        break;
    default:
...
static void esp_zb_task(void *pcParameters)
{
    ...
    ESP_ERROR_CHECK(esp_zb_io_buffer_size_set(110));
    ...
    ESP_ERROR_CHECK(esp_zb_aps_set_fragment_interframe_delay(20));
    ESP_ERROR_CHECK(esp_zb_nwk_set_link_status_period(3));
...
void app_main(void)
{
    ...
    xTaskCreate(esp_zb_task, "Zigbee_main", (10*1024), NULL, 5, NULL);
